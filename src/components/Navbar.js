...
function Navbar() {
    ...
    return (
        <nav style={{ backgroundColor: 'teal', color: 'white', padding: '10px' }}>
            <div className="navbar-container" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                ...
                <ul style={{ listStyle: 'none', display: 'flex', gap: '20px', cursor: 'pointer', margin: 0 }}>
                    ...
                    <li><HashLink smooth to="/create-donation" style={linkStyle}><span role="img" aria-label="love emoji" className="text-xl">💕</span>Create Donation💕</HashLink></li>
...
const linkStyle = {
    ...
    padding: '5px 10px',
    display: 'block',
    fontSize: '1.5rem', // This is approximately equivalent to 2xl
    fontWeight: 'bold',
};
