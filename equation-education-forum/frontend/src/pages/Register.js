...
const Register = () => {
  ...
  return (
    ...
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-r from-gray-100 to-gray-300">
      <div className="relative flex bg-white rounded-lg shadow-lg overflow-hidden w-4/5 max-w-4xl">
        {/* Left Side - Form */}
        ...
        <div className="absolute -right-5 w-1/2 h-full">
          ...
          />
          <div className="absolute inset-0 bg-red bg-opacity-90 blur-xl"></div>
        </div>
      </div>
    </div>
    <Footer/>
